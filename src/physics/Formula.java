...
//                System.out.println("term skip ;");
    ...
    public String find_derivative() {
        ...
        //TODO: product rule
        //TODO: quotient rule
        //TODO: chain rule (maybe already done? check)
        //TODO: trig
        int index_term = 0;
        for (String term : terms) {
...
//                System.out.println(Arrays.toString(nterms));
    ...
    private StringBuilder product_derivative(String term, Hashtable<Integer, Character> operators, int term_index) {
